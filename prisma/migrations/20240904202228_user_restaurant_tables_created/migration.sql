...
CREATE TABLE `users` (
    ...
    `profile_remarks` VARCHAR(191) NOT NULL DEFAULT 'User''s profile created by default.',
    `user_deletion_reason` VARCHAR(191) NULL,
    `admin_deletion_reason` VARCHAR(191) NULL,
...
CREATE TABLE `restaurants` (
    ...
    `is_active` BOOLEAN NOT NULL DEFAULT true,
    `profile_remarks` VARCHAR(191) NOT NULL DEFAULT 'Restaurant''s profile created by default.',
    `restaurant_deletion_reason` VARCHAR(191) NULL,
    `admin_deletion_reason` VARCHAR(191) NULL,
