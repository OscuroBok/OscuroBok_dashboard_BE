...
const followRestaurantprofileValidation = {
	payload: Joi.object({
		restaurantId: Joi.number().required().label("restaurantId"),
	}),
};

// unfollow restaurant profile
const unfollowRestaurantprofileValidation = {
	payload: Joi.object({
		restaurantId: Joi.number().required().label("restaurantId"),
		unfollowedReason: Joi.string().optional().label("unfollowedReason"),
	}),
};
